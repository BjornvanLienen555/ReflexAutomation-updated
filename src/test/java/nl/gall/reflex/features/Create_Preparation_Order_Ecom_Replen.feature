@parallel=false
Feature: Create a replenish preparation order for ecom

  Background:
    # get data from files
    * def preparationOrderBody = read('classpath:nl/gall/reflex/json/newPreparationOrder_Ecom_Replen.json')
    ...
    * preparationOrderBody.originator_reference = "TA_" + random_string
